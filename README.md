...
| `QI_USE_LIVE_MARKET` | `true` | Enable live market/fundamental providers. |
| `QI_USE_LIVE_NEWS` | follows `QI_USE_LIVE_MARKET`, default `true` | Enable live news. |
| `QI_USE_LIVE_ANNOUNCEMENT` | follows `QI_USE_LIVE_MARKET`, default `true` | Enable Cninfo announcements. |
| `QI_USE_LIVE_MACRO` | `true` | Enable live macro indicators. |
